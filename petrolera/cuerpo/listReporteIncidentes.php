...
$arrayP = $_SESSION['arrayReporteIncidentes'];
?>
                    ...
                    <!-- encabezado -->
                        ...
                        <?php foreach($arrayP as $array){?>
                                ...
                                <!--$array->item el item hace referencia al nombre del atributo item de la consulta la base de datos-->
                                    ...
                                    <td><a href='../Controlador/ReporteIncidenteController.php?accion=descargarPrueba&id_reporte_incidente=<?php echo $array->id_reporte_incidente; ?>'><i class="fa fa-cloud-download"></i></a> </td>                                               
                                    <td><a href="../Controlador/ReporteIncidenteController.php?accion=consultar&subaccion=editar&cedula_implicado=<?php echo $array->cedula_implicado; ?>&cedula_reportero=<?php echo $array->cedula_reportero; ?>&descripcion=<?php echo $array->descripcion; ?>" class="small-box-footer"><i class="fa fa-pencil"></i></a></td>
                                    <?php
                                    if($_SESSION['personaLogin']->getRol() == 'Administrador de Reportes'){
                                    ?>
                                        <td><a href="../Controlador/ReporteIncidenteController.php?accion=eliminar&id_reporte_incidente=<?php echo $array->id_reporte_incidente; ?>" class="small-box-footer"  > <i class="fa fa-remove"></i></a></td>
                                    <?php
                                    }
                                    ?>
